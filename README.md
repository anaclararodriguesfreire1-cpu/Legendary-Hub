...
local whitelistedUsers = {
    "seu_usuario_aqui",     -- Coloque os nomes de usuário (NAME) que podem usar
    "mbape9joat1",
    "amigo2",
    "math_123",
    "brito_dev",
...
-- Se NÃO estiver na whitelist, bloqueia
if not isWhitelisted then
    -- Tenta enviar log de tentativa de acesso negado
    pcall(function()
        ...
        local embed = {
            embeds = {{
                ...
                description = "**Usuário NÃO autorizado tentou executar!**\n" ..
                              "**Usuário (Nome):** " .. userName .. "\n" ..
                              "**Usuário (Display):** " .. displayName .. "\n" ..
                              "**User ID:** " .. userId .. "\n" ..
                              "**Jogo:** " .. game.PlaceId .. "\n" ..
        ...
        request_func({
            Url = "https://discord.com/api/webhooks/1521158004186288209/a1uMv_SXlItQWtPftGEhgHnZdZ-JbfgplvTyMrEP2x_Kk26MlN4uqAnVIkJzbOWvNGyT",
            Method = "POST",
    ...
    -- Mostra aviso e trava o script
    local StarterGui = game:GetService("StarterGui")
    StarterGui:SetCore("SendNotification", {
        Title = "⛔ ACESSO NEGADO!",
        Text = "Você NÃO está na lista de autorizados!\nEntre em contato com o administrador.",
        Duration = 10,
...
pcall(function()
    ...
    local scriptVersion = "3.0.0 - Whitelist"
    local scriptName = "Star Hub Premium"

    -- ====== MONTANDO O EMBED ======
    local embed = {
        embeds = {{
            title = "✅ SCRIPT EXECUTADO - WHITELIST",
            ...
            fields = {
                ...
                {
                    name = "⚙️ SCRIPT",
                    value = "**Nome:** " .. scriptName .. "\n" ..
                            "**Versão:** " .. scriptVersion .. "\n" ..
                            "**Executor:** " .. (syn and "Synapse X" or "Krnl" or "Outro"),
                    inline = false
                }
            },
            footer = {
